...
While I already presented the columns of the DataFrame that will be valuable to my analysis, the DataFrame required significant cleaning to arrive at a usable state. Here's a look at what it looked like before it was cleaned:
